        ...
        <div key="1" className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <main className="flex-1">
                ...
                <section className="py-12 md:py-24 bg-white dark:bg-gray-900">
                    <div className="container mx-auto px-4 md:px-6 space-y-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-200">Keistar BPM Solutions</h2>
                        <ul className="space-y-4 text-gray-600 dark:text-gray-400">
                ...
                <section className="py-12 md:py-24 bg-gray-100 dark:bg-gray-800">
                    <div className="container mx-auto px-4 md:px-6 space-y-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-200">User Benefits</h2>
